$(document).ready(function() {
  ...
  $(document).on('click', function(event) {
	...
	$('input[name="startTime"],input[name="endTime"],input[name="originalTime"], input[name="newTime"], input[name="detime"], input[name="retime"], input[name="arrtime"], input[name="deendtime"]').on('input', function() {
